...
const TERMINAL_COMMAND_IDS = {
	ADD_TO_CONTEXT: "xunlongaicode.terminalAddToContext",
	FIX: "xunlongaicode.terminalFixCommand",
	FIX_IN_CURRENT_TASK: "xunlongaicode.terminalFixCommandInCurrentTask",
	EXPLAIN: "xunlongaicode.terminalExplainCommand",
	EXPLAIN_IN_CURRENT_TASK: "xunlongaicode.terminalExplainCommandInCurrentTask",
} as const
...
export const registerTerminalActions = (context: vscode.ExtensionContext) => {
	...
	registerTerminalActionPair(
		...
		"TERMINAL_FIX",
		"What would you like XunlongAI to fix?",
	)
	...
	registerTerminalActionPair(
		...
		"TERMINAL_EXPLAIN",
		"What would you like XunlongAI to explain?",
	)
}
