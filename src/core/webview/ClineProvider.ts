...
export class ClineProvider implements vscode.WebviewViewProvider {
	public static readonly sideBarId = "xunlongaicode.SidebarProvider" // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
	public static readonly tabPanelId = "xunlongaicode.TabPanelProvider"
	...
	*/
	...
	public static async getInstance(): Promise<ClineProvider | undefined> {
		...
		if (!visibleProvider) {
			await vscode.commands.executeCommand("xunlongaicode.SidebarProvider.focus")
				...
				switch (message.type) {
					...
					case "allowedCommands":
						...
						await vscode.workspace
							.getConfiguration("xunlongaicode")
	...
	async getStateToPostToWebview() {
		...
		const allowedCommands =
			vscode.workspace.getConfiguration("xunlongaicode").get<string[]>("allowedCommands") || []
