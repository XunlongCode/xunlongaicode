...
3. Get access to the API with the following code:
    ...
    ```ts
    const clineExtension = vscode.extensions.getExtension<ClineAPI>("xunlongcode.xunlongaicode")
    ...
    **Note:** To ensure that the `xunlongcode.xunlongaicode` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:

    ```json
    "extensionDependencies": [
        "xunlongcode.xunlongaicode"
    ]
    ```
