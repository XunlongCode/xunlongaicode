...
const Announcement = ({ version, hideAnnouncement }: AnnouncementProps) => {
	return (
		<div
			...
			<p style={{ margin: "5px 0px" }}>
				To mark this new chapter, we're introducing the power to shape Xunlong AI Code into any role you need!
			...
			<p style={{ margin: "5px 0px" }}>
				We can't wait to see how you'll push Xunlong AI Code's potential even further! Share your custom modes
